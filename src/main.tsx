...
const TravelGuide = lazy(() => import("./pages/TravelGuide.tsx"));
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cream">
      <div className="text-center">
        <div className="inline-block w-8 h-8 border-2 border-navy border-t-gold rounded-full animate-spin mb-4" />
      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-background text-foreground p-6">
          <div className="max-w-lg text-center">
            <p className="text-sm font-semibold font-serif">Something went wrong</p>
